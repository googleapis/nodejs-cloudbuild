...
describe('v1.CloudBuildClient', () => {
    ...
    describe('updateBuildTrigger', () => {
        it('invokes updateBuildTrigger without error', async () => {
            ...
            const expectedHeaderRequestParams = "project_id=&trigger_id=&trigger.resource_name=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
    ...
    describe('receiveTriggerWebhook', () => {
        it('invokes receiveTriggerWebhook without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ReceiveTriggerWebhookResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.receiveTriggerWebhook as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('approveBuild', () => {
        it('invokes approveBuild without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ApproveBuildRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.approveBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
