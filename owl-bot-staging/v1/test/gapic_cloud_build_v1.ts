...
describe('v1.CloudBuildClient', () => {
    ...
    describe('getBuild', () => {
        it('invokes getBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBuildRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetBuildRequest', ['id']);
            request.id = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetBuildRequest', ['name']);
    ...
    describe('cancelBuild', () => {
        it('invokes cancelBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CancelBuildRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CancelBuildRequest', ['id']);
            request.id = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('CancelBuildRequest', ['name']);
            request.name = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&id=${defaultValue2}&name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.devtools.cloudbuild.v1.Build()
    ...
    describe('createBuildTrigger', () => {
        it('invokes createBuildTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateBuildTriggerRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CreateBuildTriggerRequest', ['parent']);
    ...
    describe('getBuildTrigger', () => {
        it('invokes getBuildTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBuildTriggerRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetBuildTriggerRequest', ['triggerId']);
            request.triggerId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetBuildTriggerRequest', ['name']);
            request.name = defaultValue3;
    ...
    describe('deleteBuildTrigger', () => {
        it('invokes deleteBuildTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBuildTriggerRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteBuildTriggerRequest', ['triggerId']);
            request.triggerId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteBuildTriggerRequest', ['name']);
            request.name = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&trigger_id=${defaultValue2}&name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateBuildTrigger', () => {
        it('invokes updateBuildTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateBuildTriggerRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateBuildTriggerRequest', ['triggerId']);
            request.triggerId = defaultValue2;
            request.trigger ??= {};
            const defaultValue3 =
              getTypeDefaultValue('UpdateBuildTriggerRequest', ['trigger', 'resourceName']);
    ...
    describe('receiveTriggerWebhook', () => {
        it('invokes receiveTriggerWebhook without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ReceiveTriggerWebhookRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ReceiveTriggerWebhookRequest', ['trigger']);
            request.trigger = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('ReceiveTriggerWebhookRequest', ['name']);
            request.name = defaultValue3;
    ...
    describe('getWorkerPool', () => {
        it('invokes getWorkerPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetWorkerPoolRequest', ['name']);
    ...
    describe('createBuild', () => {
        it('invokes createBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateBuildRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CreateBuildRequest', ['parent']);
            request.parent = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&parent=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('retryBuild', () => {
        it('invokes retryBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RetryBuildRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RetryBuildRequest', ['id']);
            request.id = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RetryBuildRequest', ['name']);
            request.name = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&id=${defaultValue2}&name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('approveBuild', () => {
        it('invokes approveBuild without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ApproveBuildRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('runBuildTrigger', () => {
        it('invokes runBuildTrigger without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RunBuildTriggerRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RunBuildTriggerRequest', ['triggerId']);
            request.triggerId = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RunBuildTriggerRequest', ['name']);
            request.name = defaultValue3;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&trigger_id=${defaultValue2}&name=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createWorkerPool', () => {
        it('invokes createWorkerPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateWorkerPoolRequest', ['parent']);
    ...
    describe('deleteWorkerPool', () => {
        it('invokes deleteWorkerPool without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteWorkerPoolRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateWorkerPool', () => {
        it('invokes updateWorkerPool without error', async () => {
            ...
            request.workerPool ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateWorkerPoolRequest', ['workerPool', 'name']);
    ...
    describe('listBuilds', () => {
        it('invokes listBuilds without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBuildsRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListBuildsRequest', ['parent']);
            request.parent = defaultValue2;
    ...
    describe('listBuildTriggers', () => {
        it('invokes listBuildTriggers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBuildTriggersRequest', ['projectId']);
            request.projectId = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListBuildTriggersRequest', ['parent']);
            request.parent = defaultValue2;
            const expectedHeaderRequestParams = `project_id=${defaultValue1}&parent=${defaultValue2}`;const expectedResponse = [
    ...
    describe('listWorkerPools', () => {
        it('invokes listWorkerPools without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListWorkerPoolsRequest', ['parent']);
            request.parent = defaultValue1;
