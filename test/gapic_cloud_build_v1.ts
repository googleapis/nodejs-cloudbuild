...
describe('v1.CloudBuildClient', () => {
    ...
    describe('getBuild', () => {
        ...
        it('invokes getBuild with error', async () => {
            ...
            await assert.rejects(async () => { await client.getBuild(request); }, expectedError);
            assert((client.innerApiCalls.getBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('cancelBuild', () => {
        ...
        it('invokes cancelBuild with error', async () => {
            ...
            await assert.rejects(async () => { await client.cancelBuild(request); }, expectedError);
            assert((client.innerApiCalls.cancelBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createBuildTrigger', () => {
        ...
        it('invokes createBuildTrigger with error', async () => {
            ...
            await assert.rejects(async () => { await client.createBuildTrigger(request); }, expectedError);
            assert((client.innerApiCalls.createBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getBuildTrigger', () => {
        ...
        it('invokes getBuildTrigger with error', async () => {
            ...
            await assert.rejects(async () => { await client.getBuildTrigger(request); }, expectedError);
            assert((client.innerApiCalls.getBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteBuildTrigger', () => {
        ...
        it('invokes deleteBuildTrigger with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteBuildTrigger(request); }, expectedError);
            assert((client.innerApiCalls.deleteBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateBuildTrigger', () => {
        ...
        it('invokes updateBuildTrigger with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateBuildTrigger(request); }, expectedError);
            assert((client.innerApiCalls.updateBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createWorkerPool', () => {
        ...
        it('invokes createWorkerPool with error', async () => {
            ...
            await assert.rejects(async () => { await client.createWorkerPool(request); }, expectedError);
            assert((client.innerApiCalls.createWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getWorkerPool', () => {
        ...
        it('invokes getWorkerPool with error', async () => {
            ...
            await assert.rejects(async () => { await client.getWorkerPool(request); }, expectedError);
            assert((client.innerApiCalls.getWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteWorkerPool', () => {
        ...
        it('invokes deleteWorkerPool with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteWorkerPool(request); }, expectedError);
            assert((client.innerApiCalls.deleteWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateWorkerPool', () => {
        ...
        it('invokes updateWorkerPool with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateWorkerPool(request); }, expectedError);
            assert((client.innerApiCalls.updateWorkerPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listWorkerPools', () => {
        ...
        it('invokes listWorkerPools with error', async () => {
            ...
            await assert.rejects(async () => { await client.listWorkerPools(request); }, expectedError);
            assert((client.innerApiCalls.listWorkerPools as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createBuild', () => {
        ...
        it('invokes createBuild with call error', async () => {
            ...
            await assert.rejects(async () => { await client.createBuild(request); }, expectedError);
            assert((client.innerApiCalls.createBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('retryBuild', () => {
        ...
        it('invokes retryBuild with call error', async () => {
            ...
            await assert.rejects(async () => { await client.retryBuild(request); }, expectedError);
            assert((client.innerApiCalls.retryBuild as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('runBuildTrigger', () => {
        ...
        it('invokes runBuildTrigger with call error', async () => {
            ...
            await assert.rejects(async () => { await client.runBuildTrigger(request); }, expectedError);
            assert((client.innerApiCalls.runBuildTrigger as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listBuilds', () => {
        ...
        it('invokes listBuilds with error', async () => {
            ...
            await assert.rejects(async () => { await client.listBuilds(request); }, expectedError);
            assert((client.innerApiCalls.listBuilds as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with listBuilds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ListBuildsRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.Build()),
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.Build()),
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.Build()),
            ];
        ...
        it('uses async iteration with listBuilds with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ListBuildsRequest());const expectedError = new Error('expected');
    ...
    describe('listBuildTriggers', () => {
        ...
        it('invokes listBuildTriggers with error', async () => {
            ...
            await assert.rejects(async () => { await client.listBuildTriggers(request); }, expectedError);
            assert((client.innerApiCalls.listBuildTriggers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with listBuildTriggers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ListBuildTriggersRequest());const expectedResponse = [
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.BuildTrigger()),
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.BuildTrigger()),
              generateSampleMessage(new protos.google.devtools.cloudbuild.v1.BuildTrigger()),
            ];
        ...
        it('uses async iteration with listBuildTriggers with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.devtools.cloudbuild.v1.ListBuildTriggersRequest());const expectedError = new Error('expected');
